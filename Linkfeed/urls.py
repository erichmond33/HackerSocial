...
urlpatterns = [
    ...
    path("post/by-date/<str:username>/<str:date>/", views.post_by_date, name="post_by_date"),
    path("comments/by-date/<str:username>/<str:date>/", views.comments_by_date, name="comments_by_date"),
